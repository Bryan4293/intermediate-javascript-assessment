...
String.prototype.grammarPolice = (str) =>{ //this is a little confusing 
  str.charAt(0,1).toUpperCase() + str.charAt(1).toLowerCase()
}
...
function valueType(type1, type2){
  if(type1===type2){
